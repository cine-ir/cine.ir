...
class ZarrinPalGateway {
    ...
    public function process_payment($payment_data) {
        ...
        // In a real implementation, you would integrate with ZarrinPal API
        
        return array(
            'success' => true,
            'transaction_id' => 'ZP_' . time(),
            ...
            'data' => array(
                'gateway_transaction_id' => 'ZP_' . time(),
    ...
    public function verify_payment($callback_data, $transaction) {
        ...
        // In a real implementation, you would verify with ZarrinPal API
